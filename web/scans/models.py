...
class SubdomainsDNS(models.Model):
    ...
    resolver = models.TextField()
    cname = models.TextField( blank=True, default="N/A")
    a_record = models.TextField( blank=True, default="N/A")
    aaaa_record = models.TextField( blank=True, default="N/A")
    mx_record = models.TextField( blank=True, default="N/A")
    soa_record = models.TextField( blank=True, default="N/A")
    ns_record = models.TextField( blank=True, default="N/A")
    internal_ips_record = models.TextField( blank=True, default="N/A")
